...
//nodemongo is the databese name 
...
MongoClient.connect(url, {
    ...
    /*var custData = [
        ...
        {name: 'Vicky', address: 'Yellow Garde 2'},
...
//ps -ef | grep mongod | grep -v grep | wc -l | tr -d ' '   did this to check if mongo was installed and it apperently is since it returned a number